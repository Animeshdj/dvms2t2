  ...
  return (
    <div className="footer">
      <div className="footer-primary">
        ...
        <div className="footer-navwrapper">
      ...
      <div className="footer-secondary">
        ...
        <div className="footer-privacy">
          <a href="/">Conditions & Disclaimer</a> |
          <a href="/">Privacy Statement</a> | <a href="/">Terms of Service</a>
        </div>
        <a href="/" className="footer-madeby">
          <span>Made by</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 26 20"
          >
            <g fill="currentColor" clipPath="url(#MadebyPath)">
