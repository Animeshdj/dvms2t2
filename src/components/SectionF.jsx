    ...
    <div className="section-6" ref={sectionRef}>
      <div className="section-6-container">
        <div className="section-6-content">
          ...
          <p>
            We map out your entire logistics flow, so you always know the
            whereabouts of your cargo. With our user-friendly tool, you have
            full control and can make quick adjustments when necessary.
          </p>
          <a href="/" className="sec3-btn">
            <span>Discover our Customer Portal</span>
